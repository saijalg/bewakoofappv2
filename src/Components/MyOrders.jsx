...
{!isButLoading &&  "Continue Shopping" }
 ...
 <VStack marginTop="180px" justify="center" >
  ...
  <Text fontSize="2xl" fontWeight="extrabold" >My {cartDataConfirmed.length} Orders(S)</Text>

    <Wrap  padding={10} spacing={50} >
      
      <VStack  spacing={5}   >

         <HStack spacing={5} w="full"  padding={3} bg="#fcffee" > <Image w={10} src='https://images.bewakoof.com/web/Red-truck.png' /> <Text>Yay! Your order is delivered</Text></HStack>
      {
        cartDataConfirmed.map((el)=> (
           <OrdersSingleCard el={el} />
        ) )
      }
