...
const AppContextProvider = ({children}) => {
  ...
  const [cartDataConfirmed, setCartDataConfirmed] = useState([])
...
handlePrice();
 ...
 // console.log(userName)
  ...
  <AppContext.Provider value={{data, userName, isAuth, toggle, loginUser, logoutUser, AllProductsData, cartData, cartDataConfirmed, handleCart, CartDataToMatch, handleChange ,handleRemove, price, discountPrice, Totalprice, cartDataEmpty,
